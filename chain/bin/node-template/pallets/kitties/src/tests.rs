...
const ACCOUNT_0: u64 = 0;
const ACCOUNT_1: u64 = 1;
const ACCOUNT_2: u64 = 2;

// 生成kitty测试
#[test]
fn it_works_creating_kitty() {
	new_test_ext().execute_with(|| {
		let account_id: u64 = ACCOUNT_0;
...
// 余额不足导致生成kitty失败
#[test]
fn create_kitty_fails_not_enough_balance() {
	new_test_ext().execute_with(|| {
		let account_id: u64 = ACCOUNT_2;
		assert_noop!(
...
// id非法导致生成失败
#[test]
fn create_kitty_fails_invalid_kitty_id() {
	new_test_ext().execute_with(|| {
		let account_id: u64 = ACCOUNT_0;
...
#[test]
fn create_kitty_fails_too_many_kitties() {
	new_test_ext().execute_with(|| {
		let account_id: u64 = ACCOUNT_0;
		assert_ok!(KittiesModule::create(Origin::signed(account_id)));
		assert_ok!(KittiesModule::create(Origin::signed(account_id)));
...
#[test]
fn breed_kitty_fails_not_enough_balance() {
	new_test_ext().execute_with(|| {
		let account_id: u64 = ACCOUNT_1;
		let kitty_id_1 = NextKittyId::<Test>::get();
		assert_ok!(KittiesModule::create(Origin::signed(account_id)));
...
#[test]
fn breed_kitty_fails_same_kitty_id() {
	new_test_ext().execute_with(|| {
		let account_id: u64 = ACCOUNT_1;
		let kitty_id_1 = NextKittyId::<Test>::get();
		assert_ok!(KittiesModule::create(Origin::signed(account_id)));
...
#[test]
fn breed_kitty_fails_invalid_kitty_id() {
	new_test_ext().execute_with(|| {
		let account_id: u64 = ACCOUNT_0;
...
#[test]
fn breed_kitty_fails_too_many_kitties() {
	new_test_ext().execute_with(|| {
		let account_id: u64 = ACCOUNT_0;
...
#[test]
fn it_works_transfering_kitty() {
	new_test_ext().execute_with(|| {
		let account_id_1: u64 = ACCOUNT_0;
		let account_id_2: u64 = ACCOUNT_1;
...
#[test]
fn transfer_kitty_fails_not_enough_balance() {
	new_test_ext().execute_with(|| {
		let account_id_1: u64 = ACCOUNT_0;
		let account_id_2: u64 = ACCOUNT_2;
		let kitty_id_1 = NextKittyId::<Test>::get();
		assert_ok!(KittiesModule::create(Origin::signed(account_id_1)));
...
#[test]
fn transfer_kitty_fails_not_owner() {
	new_test_ext().execute_with(|| {
		let account_id_1: u64 = ACCOUNT_0;
		let account_id_2: u64 = ACCOUNT_1;
		let kitty_id_1 = NextKittyId::<Test>::get();
...
#[test]
fn transfer_kitty_fails_too_many_kitties() {
	new_test_ext().execute_with(|| {
		let account_id_1: u64 = ACCOUNT_1;
		let account_id_2: u64 = ACCOUNT_0;
		let kitty_id_1 = NextKittyId::<Test>::get();
		assert_ok!(KittiesModule::create(Origin::signed(account_id_1)));
		assert_ok!(KittiesModule::create(Origin::signed(account_id_2)));
		assert_ok!(KittiesModule::create(Origin::signed(account_id_2)));
